...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/bytedance/ios/Telegram-iOS/build-input/gen/project/bazel',
    '/private/var/tmp/_bazel_bytedance/73f5f5fa3b3fae0b2c637ec69aa6bf7b/execroot/__main__',
    'ios_x86_64',
    {
        'macos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/bytedance/Library/Application Support/Tulsi/0.20210316.88/Bazel',
